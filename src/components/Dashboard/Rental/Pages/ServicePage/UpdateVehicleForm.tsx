...
type UpdateServiceVehicleProps = {
  handleCancel: () => void;
  selectedServiceId: number | undefined;
  selectedVehicleData: VehicleData | undefined;
}

const UpdateServiceVehicle: React.FC<UpdateServiceVehicleProps> = ({
  handleCancel,
  selectedServiceId,
  selectedVehicleData,
}) => {
  ...
  const [insDateObj, setInsStateObj] = useState<dayjs.Dayjs | null>(null);
  const [fcDate, setFcState] = useState<string>("");
  const [fcDateObj, setFcStateObj] = useState<dayjs.Dayjs | null>(null);
